...
const Hero = () => {
  return (
    <>
      <div className="h-[50rem] w-full bg-[#07080e] bg-dot-white/[0.2]  relative">
        <div className="absolute pointer-events-none inset-0 flex items-center justify-center bg-[#07080e] [mask-image:radial-gradient(ellipse_at_center,transparent_10%,black)]"></div>
        <div className="max-w-[1140px] pt-28 mx-auto items-center flex flex-col gap-4  justify-center">
          ...
          <motion.p
            ...
            className="text-[25px] font-bold text-center leading-7 text-blue-50 md:text-5xl sm:text-4xl lg:text-6xl 2xl:text-[76px]"
          >
          ...
          <motion.p
            ...
            className="md:text-base sm:text-sm text-xs text-center md:max-w-[550px] text-zinc-200"
          >
